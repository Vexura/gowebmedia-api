...
class Manage
{
    ...
    public function get(int $vm_id){
        return $this->GoWebMediaAPI->get('products/rootserver/manage/' . $vm_id . '/get');
    }

    public function stats(int $vm_id){
        return $this->GoWebMediaAPI->get('products/rootserver/manage/' . $vm_id . '/stats');
    }

    public function start(int $vm_id){
        return $this->GoWebMediaAPI->post('products/rootserver/manage/' . $vm_id . '/start');
    }

    public function kill(int $vm_id){
        return $this->GoWebMediaAPI->post('products/rootserver/manage/' . $vm_id . '/stop');
    }

    public function stop(int $vm_id){
        return $this->GoWebMediaAPI->post('products/rootserver/manage/' . $vm_id . '/shutdown');
    }

    public function restart(int $vm_id){
        return $this->GoWebMediaAPI->post('products/rootserver/manage/' . $vm_id . '/restart');
    }

    public function reinstall(int $vm_id, int $os_id, string $root_password){
        return $this->GoWebMediaAPI->post('products/rootserver/manage/' . $vm_id . '/reinstall', [
    ...
    public function delete(int $vm_id){
        return $this->GoWebMediaAPI->delete('products/rootserver/manage/' . $vm_id . '/delete');
    }
